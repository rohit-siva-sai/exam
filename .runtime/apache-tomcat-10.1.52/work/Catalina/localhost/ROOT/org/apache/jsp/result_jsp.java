...
public final class result_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final jakarta.servlet.http.HttpServletRequest request, final jakarta.servlet.http.HttpServletResponse response)
    ...
    int gauge = (int) Math.round(percent);
      ...
      out.write("    <title>Result Lens | Exam Grid 2050</title>\n");
      ...
      out.write("<div class=\"fixed inset-0 -z-10 bg-[radial-gradient(circle_at_20%_10%,rgba(16,185,129,0.2),transparent_30%),radial-gradient(circle_at_80%_8%,rgba(14,165,233,0.25),transparent_34%),linear-gradient(145deg,#020617,#0b1123,#111827)]\"></div>\n");
      out.write("<div class=\"max-w-6xl mx-auto px-4 py-8\">\n");
      out.write("    <div class=\"flex items-center justify-between\">\n");
      out.write("        <div>\n");
      out.write("            <p class=\"text-xs uppercase tracking-[0.25em] text-cyan-300\">");
      out.print( esc(String.valueOf(selected.get("testId"))) );
      out.write("</p>\n");
      out.write("            <h1 class=\"font-display text-3xl md:text-4xl\">");
      out.print( esc(String.valueOf(selected.get("testName"))) );
      out.write("</h1>\n");
      out.write("        </div>\n");
      out.write("        <a href=\"dashboard.jsp\" class=\"px-4 py-2 rounded-xl border border-white/20 hover:bg-white/10\">Dashboard</a>\n");
      out.write("    </div>\n");
      out.write("\n");
      out.write("    <section class=\"grid md:grid-cols-[220px_1fr] gap-4 mt-6\">\n");
      out.write("        <div class=\"rounded-2xl border border-white/15 bg-white/10 p-5 flex flex-col items-center justify-center\">\n");
      out.write("            <div class=\"w-36 h-36 rounded-full grid place-items-center\" style=\"background: conic-gradient(");
      out.print( passed ? "#34d399" : "#f87171" );
      out.write(' ');
      out.print( gauge );
      out.write("%, rgba(148,163,184,0.18) 0);\">\n");
      out.write("                <div class=\"w-28 h-28 rounded-full bg-slate-950 grid place-items-center\">\n");
      out.write("                    <p class=\"font-display text-2xl\">");
      out.print( gauge );
      out.write("%</p>\n");
      out.write("                </div>\n");
      out.write("            </div>\n");
      out.write("            <p class=\"mt-3 text-sm ");
      out.print( passed ? "text-emerald-300" : "text-red-300" );
      out.write('"');
      out.write('>');
      out.print( passed ? "PASS" : "FAIL" );
      out.write("</p>\n");
      out.write("        </div>\n");
      out.write("\n");
      out.write("        <div class=\"rounded-2xl border border-white/15 bg-white/10 p-5\">\n");
      out.write("            <div class=\"grid sm:grid-cols-4 gap-3\">\n");
      out.write("                <div class=\"rounded-xl bg-slate-900/55 border border-white/10 p-3\">\n");
      out.write("                    <p class=\"text-xs text-slate-400\">Score</p>\n");
      ...
      out.write("                </div>\n");
      out.write("                <div class=\"rounded-xl bg-slate-900/55 border border-white/10 p-3\">\n");
      out.write("                    <p class=\"text-xs text-slate-400\">Accuracy</p>\n");
      out.write("                    <p class=\"text-2xl font-semibold\">");
      out.print( String.format("%.2f", percent) );
      out.write("%</p>\n");
      out.write("                </div>\n");
      out.write("                <div class=\"rounded-xl bg-slate-900/55 border border-white/10 p-3\">\n");
      out.write("                    <p class=\"text-xs text-slate-400\">Pass Cutoff</p>\n");
      out.write("                    <p class=\"text-2xl font-semibold\">");
      out.print( String.format("%.0f", passCutoff) );
      out.write("%</p>\n");
      out.write("                </div>\n");
      out.write("                <div class=\"rounded-xl bg-slate-900/55 border border-white/10 p-3\">\n");
      out.write("                    <p class=\"text-xs text-slate-400\">Time Spent</p>\n");
      out.write("                    <p class=\"text-2xl font-semibold\">");
      out.print( spentSec );
      out.write("s</p>\n");
      out.write("                </div>\n");
      out.write("            </div>\n");
      out.write("            <div class=\"mt-4 text-sm text-slate-300\">\n");
      out.write("                <p><span class=\"text-slate-400\">Started:</span> ");
      out.print( esc(startTime.toString()) );
      out.write("</p>\n");
      out.write("                <p><span class=\"text-slate-400\">Submitted:</span> ");
      out.print( esc(endTime.toString()) );
      out.write("</p>\n");
      out.write("                <p><span class=\"text-slate-400\">Attempt ID:</span> <span class=\"font-mono text-xs\">");
      out.print( esc(String.valueOf(selected.get("attemptId"))) );
      out.write("</span></p>\n");
      out.write("            </div>\n");
      out.write("        </div>\n");
      out.write("    </section>\n");
      ...
      out.write("        <h2 class=\"font-display text-2xl\">Answer Audit</h2>\n");
      out.write("        <div class=\"mt-4 grid gap-3\">\n");
      out.write("            ");
 for (Map<String, Object> r : review) {
      ...
      out.write("\n");
      out.write("            <article class=\"rounded-xl border ");
      out.print( ok ? "border-emerald-400/30 bg-emerald-500/10" : "border-red-400/30 bg-red-500/10" );
      out.write(" p-4\">\n");
      out.write("                <p class=\"font-medium\">");
      out.print( esc(String.valueOf(r.get("qid"))) );
      out.write('.');
      out.write(' ');
      out.print( esc(String.valueOf(r.get("question"))) );
      out.write("</p>\n");
      out.write("                <p class=\"text-sm mt-2 ");
      out.print( ok ? "text-emerald-200" : "text-red-200" );
      out.write("\">Your answer: ");
      out.print( s >= 0 ? esc(options[s]) : "Not answered" );
      out.write("</p>\n");
      out.write("                <p class=\"text-sm text-cyan-200\">Correct answer: ");
      out.print( esc(options[c]) );
      out.write("</p>\n");
      out.write("            </article>\n");
      out.write("            ");
 } 
