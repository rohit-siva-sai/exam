...
public final class login_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final jakarta.servlet.http.HttpServletRequest request, final jakarta.servlet.http.HttpServletResponse response)
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
      ...
      out.write("    <title>Portal Access | Exam Grid 2050</title>\n");
      ...
      out.write("    </style>\n");
      out.write("</head>\n");
      out.write("<body class=\"min-h-screen font-body text-slate-100 bg-slate-950 overflow-x-hidden\">\n");
      out.write("<div class=\"fixed inset-0 -z-10 bg-[radial-gradient(circle_at_15%_15%,rgba(16,185,129,0.22),transparent_30%),radial-gradient(circle_at_80%_20%,rgba(59,130,246,0.3),transparent_35%),linear-gradient(145deg,#020617,#0b1123_55%,#111827)]\"></div>\n");
      out.write("<div class=\"max-w-6xl mx-auto px-4 py-10 md:py-16 grid md:grid-cols-2 gap-8 items-center\">\n");
      out.write("    <section>\n");
      out.write("        <p class=\"uppercase tracking-[0.35em] text-emerald-300 text-xs\">Exam Grid 2050</p>\n");
      out.write("        <h1 class=\"font-display text-4xl md:text-6xl leading-tight mt-3\">Neural Assessment Portal</h1>\n");
      out.write("        <p class=\"text-slate-300 mt-4 max-w-lg\">Multi-track certification exams with timed execution, instant scoring, and performance analytics.</p>\n");
      out.write("        <div class=\"grid grid-cols-3 gap-3 mt-8 max-w-lg\">\n");
      out.write("            <div class=\"rounded-xl border border-cyan-400/30 bg-cyan-500/10 px-3 py-4\">\n");
      out.write("                <p class=\"text-xs text-cyan-200\">Tracks</p>\n");
      out.write("                <p class=\"text-2xl font-semibold\">");
      out.print( testCatalog.size() );
      out.write("</p>\n");
      out.write("            </div>\n");
      out.write("            <div class=\"rounded-xl border border-emerald-400/30 bg-emerald-500/10 px-3 py-4\">\n");
      out.write("                <p class=\"text-xs text-emerald-200\">Questions</p>\n");
      out.write("                <p class=\"text-2xl font-semibold\">");
      out.print( totalQuestionsAcrossTests );
      out.write("</p>\n");
      out.write("            </div>\n");
      out.write("            <div class=\"rounded-xl border border-blue-400/30 bg-blue-500/10 px-3 py-4\">\n");
      out.write("                <p class=\"text-xs text-blue-200\">Mode</p>\n");
      out.write("                <p class=\"text-2xl font-semibold\">Live</p>\n");
      out.write("            </div>\n");
      out.write("        </div>\n");
      out.write("    </section>\n");
      out.write("\n");
      out.write("    <section class=\"rounded-3xl border border-white/15 bg-white/10 backdrop-blur-xl p-7 md:p-9 shadow-2xl shadow-cyan-900/20\">\n");
      out.write("        <h2 class=\"font-display text-2xl\">Student Login</h2>\n");
      out.write("        <p class=\"text-slate-300 mt-2\">Authenticate to continue to your command dashboard.</p>\n");
      out.write("\n");
      out.write("        ");
 if (!error.isEmpty()) { 
      out.write("\n");
      ...
      out.write("\n");
      out.write("\n");
      out.write("        <form method=\"post\" class=\"mt-6 space-y-4\">\n");
      out.write("            <div>\n");
      out.write("                <label class=\"text-xs uppercase tracking-[0.18em] text-slate-300\">Username</label>\n");
      out.write("                <input name=\"username\" required class=\"mt-2 w-full rounded-xl border border-white/20 bg-slate-900/70 px-3 py-3 outline-none focus:border-cyan-300\" placeholder=\"enter username\">\n");
      out.write("            </div>\n");
      out.write("            <div>\n");
      out.write("                <label class=\"text-xs uppercase tracking-[0.18em] text-slate-300\">Password</label>\n");
      out.write("                <input type=\"password\" name=\"password\" required class=\"mt-2 w-full rounded-xl border border-white/20 bg-slate-900/70 px-3 py-3 outline-none focus:border-cyan-300\" placeholder=\"enter password\">\n");
      out.write("            </div>\n");
      out.write("            <button class=\"w-full rounded-xl bg-gradient-to-r from-cyan-400 to-emerald-400 text-slate-900 font-semibold py-3 hover:brightness-110 transition\">Enter Grid</button>\n");
      out.write("        </form>\n");
      out.write("\n");
      out.write("        <p class=\"mt-5 text-sm text-slate-300\">No account yet?\n");
      out.write("            <a class=\"text-emerald-300 hover:underline\" href=\"signup.jsp\">Create one</a>\n");
      out.write("        </p>\n");
      out.write("    </section>\n");
      out.write("</div>\n");
      out.write("</body>\n");
